...
File contains:
- avg_propn.py : calculate the normalised proportion of non-transferables of each active constituency and take average, at each count. cumulative.
- non_cumul.py : treat the valid polls of each constituency as one big valid poll, at each count.
